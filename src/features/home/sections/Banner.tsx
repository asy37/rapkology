  ...
  return (
    <div className="relative w-full h-[642px]">
      ...
      <Image
        ...
        src="/banner/bannermobile.png"
        alt="banner"
        fill
        priority
      />
      <div className="flex gap-2 absolute z-10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 p-4 w-74 border rounded-4xl border-gray-700 -rotate-4">
